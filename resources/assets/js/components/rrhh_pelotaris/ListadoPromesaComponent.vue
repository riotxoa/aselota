  ...
  <div class="container-fluid">
    <b-row>
      ...
      <b-col class="col-sm-6 text-right my-1 mb-3">
        <router-link :to="{ name: 'rrhh.pelotari.new', params: { promesa: 1 }}" class="text-white"><b-btn variant="danger" class="mb-0" title="Crear Pelotari">Nueva Promesa</b-btn></router-link>
      </b-col>
...
<script>
  ...
  export default {
      ...
      methods: {
        ...
        remove () {
          let uri = '/www/pelotaris-promesa/' + this.deleteId;
