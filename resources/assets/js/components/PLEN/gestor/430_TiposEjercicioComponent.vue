<template>
  <div>
    <p class="module-title py-2 text-center">Tipos de Ejercicio</p>
    <b-container class="p-xl-3">
      <b-button :disabled="edit_index > 0" @click="addNewItem" variant="danger" class="float-right mb-3">Nuevo Tipo de Ejercicio</b-button>
    ...
    <b-modal ref="confirm-delete-modal"
             title="Borrar Tipo de Ejercicio"
             @ok="deleteItem"
      ...
      <p>Va a borrar el siguiente Tipo de Ejercicio:</p>
      <ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        deleteTipo: 'plen/deleteTipoEjercicio',
        getTipos: 'plen/getTiposEjercicio',
        saveTipo: 'plen/saveTipoEjercicio',
        showSnackBar: 'plen/showSnackBar',
        updateTipo: 'plen/updateTipoEjercicio',
      }),
      addNewItem() {
        this.add_new = true;
