<template>
  <div>
    <p class="module-title py-2 text-center">Tipos de Mesociclo</p>
    <b-container class="p-xl-3">
      <b-button :disabled="edit_index > 0" @click="addNewItem" variant="danger" class="float-right mb-3">Nuevo Tipo de Mesociclo</b-button>
    ...
    <b-modal ref="confirm-delete-modal"
             title="Borrar Tipo de Mesociclo"
             @ok="deleteItem"
      ...
      <p>Va a borrar el siguiente Tipo de Mesociclo:</p>
      <ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        deleteTipo: 'plen/deleteTipoMesociclo',
        getTipos: 'plen/getTiposMesociclo',
        saveTipo: 'plen/saveTipoMesociclo',
        showSnackBar: 'plen/showSnackBar',
        updateTipo: 'plen/updateTipoMesociclo',
      }),
      addNewItem() {
        this.add_new = true;
      ...
      deleteItem() {
        this.deleteTipo(this.item_delete.id)
          .then( () => {
      ...
      saveItem(index) {
        this.saveTipo(this.item_new)
          .then( (item) => {
            ...
            this.showSnackBar("Nuevo TIPO guardado");
          })
          .catch( () => {
