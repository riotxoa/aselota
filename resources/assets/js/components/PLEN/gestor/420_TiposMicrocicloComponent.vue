<template>
  <div>
    ...
    <b-modal ref="confirm-delete-modal"
      ...
      <p>Va a borrar el siguiente Tipo de Microciclo:</p>
      <ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        deleteTipo: 'plen/deleteTipoMicrociclo',
        getTipos: 'plen/getTiposMicrociclo',
        saveTipo: 'plen/saveTipoMicrociclo',
        showSnackBar: 'plen/showSnackBar',
        updateTipo: 'plen/updateTipoMicrociclo',
      }),
      addNewItem() {
        this.add_new = true;
