...
class Med2PartesEnfermedadController extends Med2PartesController
{
    public function getAll(Request $request)
    {
      ...
      $partes = Med2PEnfermedad::select('pelotaris.id', 'pelotaris.num_trabajador', 'pelotaris.alias', 'pelotaris.posicion', 'pelotaris.promesa', 'pelotaris.fecha_nac', 'pelotaris.email', 'pelotaris.telefono', 'pelotaris.foto', 'med2_p_enfermedad.*')
